...
Voraussetzung:
- Windows PC
- Gedumpte keys.dat von deiner Switch Konsole - um deine Keys zu bekommen schaue hier -> (https://psxtools.de/index.php/Thread/76547)
...
Requirement:
- Windows PC
- Dumped keys.dat from your Switch console - to get your keys look here -> (https://psxtools.de/index.php/Thread/76547)
